...
import lk.quiz.ijse.controller.itemController;
...
public class itemForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean saveItem = itemController.saveItem(new item(Integer.parseInt(jTextField1.getText()), jTextField2.getText(), Integer.parseInt(jTextField3.getText())));
        if (saveItem) {
